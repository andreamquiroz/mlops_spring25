...
class ForeachFlow(FlowSpec):
    ...
    @step
    def start(self):
        self.creatures = ['bird', 'mouse', 'dog', 'dilophosaurus']
    ...
    def join(self, inputs):
        self.best = min(inputs, key=lambda x: x.score).creature # similar to argmax, this will return which input has maximum score
        self.next(self.end)
